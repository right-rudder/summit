export const aopaFAQs = [
  {
    title: "What funding is available from AOPA Aviation Finance?",
    content: "Up to $20,000 in total funding is available.",
  },
  {
    title: "Are rates variable or fixed?",
    content: "Rates are WSJ Prime + a fixed percentage based on credit score.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Those with limited credit experience or income often will often need a co-signer.",
  },
  {
    title: "What are the repayment terms?",
    content: "Currently, payments are $25/month per $1000 borrowed.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Yes, you must be an AOPA member to qualify. Joining is easy and a free introductory student pilot membership is offered.",
  },
];
