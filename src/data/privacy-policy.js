const privacyPolicies = {
  data: {
    heading: `Privacy Policy of<br /> Summit Flight Academy`,
    subheading: `Last updated: 12-12-2024`,
    content: [
      {
        heading: "Introduction",
        paragraphs: [
          "Summit Flight Academy LLC operates the https://www.summitflightacademy.com/ website, which provides digital marketing services for flight schools.",
          "This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Summit Flight Academy website.",
          "If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.",
          "The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://www.summitflightacademy.com/tos, unless otherwise defined in this Privacy Policy.",
        ],
      },
      {
