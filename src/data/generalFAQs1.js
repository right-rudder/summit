export const GeneralFAQs = [
  ...
  },
  {
    ...
    content: `<a href="https://www.flightcircle.com/shop/325431594e72/4000002368" target="_blank" class="link">Click here</a> to book your flight. Alternately you can email us at <a href="mailto:info@summit-flight.com" target="_blank" class="link">info@summit-flight.com</a>, or call our office at <a href="tel:8162969892" target="_blank" class="link">(816) 296-9892</a>.`,
  },
  {
  ...
  },
  {
    ...
    content: "Ground school serves two purposes:",
    oList: [
      "To learn the information needed to pass your FAA knowledge exam, the results of which must be provided to your examiner when you sit for your practical test (aka Checkride).",
      "To teach you core aviation concepts that are critical to flight. It is often cheaper and more effective to teach many topics while on the ground in an environment most conducive to learning. This helps make your in-flight time more productive and efficiently.",
    ],
    paragraph4: `We recommend our students take a hybrid approach to their ground school:`,
    list: [
    ...
    paragraph5: `For some students, an in-person classroom-based ground school may be more appropriate to their learning process. In those cases, we can recommend a couple of options for you. Your ground school training covers these topics:`,
    list2: [
  ...
  },
  {
    ...
    paragraph1: `Your costs to earn your private pilot certificate are made up of several components, including:`,
    list: [
  ...
  },
  {
    ...
    content: `Congratulations and welcome to Summit Flight Academy! Here's what you need to get started:`,
    paragraph1: `<strong>Summit Flight Academy Enrollment Interest Form:</strong><br>
    ...
    <strong>Pilot Supplies:</strong><br><ul class="mt-2 mb-3 list-disc"><li class="ml-3 text-justify">Review our FAQ on pilot supplies and discuss your needs with your instructor. Visit <a href="https://www.summitflightacademy.com/about/visit-us/" target="_blank" class="link">our office</a> to purchase or order the necessary supplies.</li></ul>`,
    note: `By following these steps, you'll be well on your way to becoming a pilot. We're excited to guide you through this thrilling journey!`,
  },
  {
