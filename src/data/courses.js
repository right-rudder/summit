export const courses = [
  {
    ...
    alt: "Cessna 172 at Summit Santa Teresa, NM",
  ...
  },
  {
    ...
    content: [
      "A Certified Flight Instructor (CFI) is more than an instructor; they are mentors and coaches for aspiring pilots, guiding them on their journey to becoming aviators. As a CFI, you play a pivotal role in shaping the future of aviation. Beyond imparting technical skills, CFIs inspire and mentor student pilots, instilling a passion for flight and upholding the highest standards of safety and professionalism. Summit takes pride in offering top-notch CFI training, preparing you to make a lasting impact in the aviation community.",
      "CFI training at Summit immerses you in instruction, covering essential aspects of aviation education, effective communication, and hands-on teaching techniques. Our CFI training program is designed to equip you with the tools and expertise necessary to guide the next generation of pilots. Dive into a curriculum that focuses on effective teaching methods and fosters a supportive environment for your growth as an instructor. Connect with the Summit team, explore our facilities, and review the detailed syllabus to kickstart your fulfilling journey as a CFI.",
      "Becoming a CFI is more than a career choice; it's an opportunity to make a lasting impact on the aviation community. Discover if becoming a CFI is the right path for you. If you're nearing 250 hours and contemplating your next steps after commercial pilot training, consider the rewarding path of becoming a CFI. At Summit, we understand the importance of aligning your career goals with your aspirations. Explore if instructing is right for you by answering essential questions. Do you find joy in teaching others? Do you have a passion for aviation and safety? If your answers align with these, CFI training at Summit is your opportunity to leave a positive legacy in aviation.",
      "Initiate your CFI training journey by reaching out to the Summit team. Explore our facilities, connect with our team, and review the syllabus to kickstart your career as a mentor and coach in aviation. Your journey to becoming a Certified Flight Instructor begins with Summit. Contact our team today to start your training and become a mentor to aspiring pilots. Explore our state-of-the-art facilities, connect with experienced instructors, and take the first step toward shaping the future of aviation. Enroll today and make a lasting impact as a CFI.",
    ],
  },
  {
    id: "4",
    imagePath: "/img/training-courses/cfi-instrument.webp",
    alt: "Become a CFII at Summit Flight Academy and mentor instrument pilots",
    ...
    content: [
      "A Certified Flight Instructor Instrument (CFII) is an expert in instrument flight, mentoring student pilots to become proficient in flying under instrument flight rules (IFR). As a CFII, you go beyond traditional flight instruction by specializing in instrument flight. Summit's CFII program equips you to guide aspiring pilots in mastering the intricacies of instrument flying. By adding this certification to your repertoire, you become a vital resource for students seeking to enhance their skills and navigate the skies confidently in various conditions.",
      "Summit's CFII training program immerses you in instruction, focusing on aviation education, effective communication, and hands-on teaching techniques tailored specifically for instrument flight. Prepare to delve into a curriculum designed to enhance your instructional abilities in the realm of instrument flight. Summit provides the tools and expertise necessary to foster a supportive environment for your growth as a CFII. Connect with our team, explore our facilities, and review the detailed syllabus to kickstart your journey toward becoming a proficient instrument flight instructor.",
      ...
      "Initiate your journey as a Certified Flight Instructor Instrument by reaching out to the Summit team. Explore our facilities, connect with our team, and review the syllabus to kickstart your career as a mentor in instrument flight. Your path to becoming a proficient CFII begins with Summit. Contact our team today to start your training and become a mentor to aspiring pilots seeking instrument proficiency. Explore our state-of-the-art facilities, connect with experienced instructors, and take the first step toward shaping the future of aviation with an instrument rating. Enroll today and make an impact as a CFII.",
    ],
  },
  {
    id: "5",
    imagePath: "/img/training-courses/military.webp",
    alt: "Many of our students come from Ft. Bliss and complete their pilot training at Summit Flight Academy",
